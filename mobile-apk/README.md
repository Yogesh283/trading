...
**Launcher icon:** Brand logo `frontend/public/brand/logo.png` को Android में `res/drawable/ic_brand_logo.png` और सभी `mipmap-*/ic_launcher*.png` पर कॉपी किया जाता है; adaptive foreground `res/drawable/ic_launcher_foreground_brand.xml`। Logo बदलने के बाद ये फाइलें दोबारा कॉपी करें और **नया APK** बनाएं।
...
लैंडिंग लिंक (default): **`/api/mobile-app`** — **`/api/android-app.apk`** aur **`/downloads/UpDownFX.apk`** bhi same file।
